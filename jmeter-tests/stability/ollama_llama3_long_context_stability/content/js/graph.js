...
var activeThreadsOverTimeInfos = {
        data: {"result": {"minY": 1.0, "minX": 1.76231646E12, "maxY": 1.0, "series": [{"data": [[1.76231646E12, 1.0]], "isOverall": false, "label": "Long Context", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.76231646E12, "title": "Active Threads Over Time"}},
        getOptions: function() {
            return {
                series: {
                    stack: true,
...
var timeVsThreadsInfos = {
        data: {"result": {"minY": 89.0, "minX": 1.0, "maxY": 89.0, "series": [{"data": [[1.0, 89.0]], "isOverall": false, "label": "Ollama llama3 Multi-turn", "isController": false}, {"data": [[1.0, 89.0]], "isOverall": false, "label": "Ollama llama3 Multi-turn-Aggregated", "isController": false}], "supportsControllersDiscrimination": true, "maxX": 1.0, "title": "Time VS Threads"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var bytesThroughputOverTimeInfos = {
        data : {"result": {"minY": 2.7666666666666666, "minX": 1.76231646E12, "maxY": 4.933333333333334, "series": [{"data": [[1.76231646E12, 2.7666666666666666]], "isOverall": false, "label": "Bytes received per second", "isController": false}, {"data": [[1.76231646E12, 4.933333333333334]], "isOverall": false, "label": "Bytes sent per second", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.76231646E12, "title": "Bytes Throughput Over Time"}},
        getOptions : function(){
            return {
                series: {
                    lines: {
...
var responseTimesOverTimeInfos = {
        data: {"result": {"minY": 89.0, "minX": 1.76231646E12, "maxY": 89.0, "series": [{"data": [[1.76231646E12, 89.0]], "isOverall": false, "label": "Ollama llama3 Multi-turn", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.76231646E12, "title": "Response Time Over Time"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var latenciesOverTimeInfos = {
        data: {"result": {"minY": 86.0, "minX": 1.76231646E12, "maxY": 86.0, "series": [{"data": [[1.76231646E12, 86.0]], "isOverall": false, "label": "Ollama llama3 Multi-turn", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.76231646E12, "title": "Latencies Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var connectTimeOverTimeInfos = {
        data: {"result": {"minY": 80.0, "minX": 1.76231646E12, "maxY": 80.0, "series": [{"data": [[1.76231646E12, 80.0]], "isOverall": false, "label": "Ollama llama3 Multi-turn", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.76231646E12, "title": "Connect Time Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var responseTimeVsRequestInfos = {
    data: {"result": {"minY": 89.0, "minX": 1.0, "maxY": 89.0, "series": [{"data": [[1.0, 89.0]], "isOverall": false, "label": "Failures", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 1000, "maxX": 1.0, "title": "Response Time Vs Request"}},
    getOptions: function() {
        return {
            series: {
                lines: {
...
var latenciesVsRequestInfos = {
    data: {"result": {"minY": 86.0, "minX": 1.0, "maxY": 86.0, "series": [{"data": [[1.0, 86.0]], "isOverall": false, "label": "Failures", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 1000, "maxX": 1.0, "title": "Latencies Vs Request"}},
    getOptions: function() {
        return{
            series: {
                lines: {
